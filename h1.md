...
<img src='https://github.com/iines-j/palvelin-kurssi/assets/148907657/5f39ef7e-3037-4bd9-a2b1-e71a12d9a173' width=600 />
<img src='https://github.com/iines-j/palvelin-kurssi/assets/148907657/9975c212-aa7f-4040-8846-347cb7c8ec8c' width=400 />

<br>

### service
- `sudo salt-call --local -l info state.single service.running apache2 enable=True` - tarkistaa onko apache2 päällä
- `sudo salt-call --local -l info state.single service.dead apache2 enable=False` - tarkistaa onko apache2 pois päältä
